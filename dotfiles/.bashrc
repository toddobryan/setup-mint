...
# Show the current git branch in the prompt (via git's __git_ps1, loaded by
# bash-completion further down). GIT_PS1_SHOWDIRTYSTATE adds * (unstaged) /
# + (staged) after the branch; drop it if it feels slow in very large repos.
